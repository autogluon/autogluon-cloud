...
class RayAWSClusterManager(RayClusterManager):
    @staticmethod
    def generate_default_permission(account_id: str, output_path: str) -> Dict[str, str]:
        """
        ...
        iam_policy = replace_iam_policy_place_holder(
            policy_document=RAY_AWS_IAM_POLICY_FILE_NAME, account_id=account_id, bucket=None
        )
