...
```python
{
    ...
    'fit_job': {
        'name': 'ag-timeseries-1668188968-e5c3',
        'status': 'Completed',
        'framework_version': '0.6.1',
        'artifact_path': 's3://XXX/timeseries-demo/model/ag-timeseries-1668188968-e5c3/output/model.tar.gz'
    },
    'recent_transform_job': {
        'name': 'ag-timeseries-1668189393-e95c',
        'status': 'Completed',
        'result_path': 's3://XXX/timeseries-demo/batch_transform/2022-11-11-17-56-33-991/results/test.parquet.out'
    },
    'transform_jobs': ['ag-timeseries-1668189393-e95c'],
    'endpoint': 'ag-timeseries-1668189208-d23b'
}
```
